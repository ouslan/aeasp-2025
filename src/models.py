...
def init_dp03_table(db_path: str) -> None:
    ...
    conn.sql(
        ...
        CREATE TABLE IF NOT EXISTS "DP03Table" (
            ...
            work_fish INTEGER,
            work_manage INTEGER,
            work_business INTEGER,
            work_finance INTEGER,
            work_computer INTEGER,
            work_architecture INTEGER,
            work_law INTEGER,
            work_education INTEGER,
            work_health INTEGER,
            in_education INTEGER,
            work_art_entertainment INTEGER,
            work_sales INTEGER,
            work_office_administration INTEGER,
            total_house INTEGER,
